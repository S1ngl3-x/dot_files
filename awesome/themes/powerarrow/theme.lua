...
local mytextclock = wibox.widget.textclock(markup("#C0C0C0", "%A %d %B ") .. markup("#de5e1e", ">") .. markup("#FFFFFF", " %H:%M "))
...
--            wibox.container.background(wibox.container.margin(binclock.widget, dpi(4), dpi(8)), "#777E76"),
            wibox.container.background(wibox.container.margin(clockicon, dpi(4), dpi(8)), "#777E76"),
